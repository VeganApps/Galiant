...
const goals: Goal[] = [
  {
    ...
    color: "#10B981",
    description:
      "Building a safety net for unexpected expenses and financial emergencies.",
  ...
  },
  {
    ...
    color: "#3B82F6",
    description:
      "Dream trip to Japan including flights, accommodation, and experiences.",
    category: "Travel",
  },
  {
    id: "3",
    ...
    color: "#8B5CF6",
    description:
      "Upgrading to the latest MacBook Pro for work and creative projects.",
    category: "Technology",
  },
  {
    id: "4",
    ...
    >
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          {/* Goal Header Card */}
          <View
            style={[styles.goalHeaderCard, { borderLeftColor: goal.color }]}
          >
          ...
          <View style={styles.progressCard}>
            ...
            <View style={styles.progressBarContainer}>
              ...
              <Text style={styles.progressBarText}>
                CHF {goal.currentAmount.toLocaleString()} of CHF{" "}
          ...
          <View style={styles.timelineCard}>
            ...
            <View style={styles.timelineItem}>
              ...
              <View style={styles.timelineContent}>
                ...
                <Text style={styles.timelineValue}>
                  CHF {goal.monthlySavings.toLocaleString()}
                </Text>
                <Text style={styles.timelineSubtext}>
                  CHF {progress.weeklySavings}/week • CHF{" "}
                  {progress.dailySavings}/day
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.milestonesCard}>
            ...
            <View style={styles.milestonesList}>
              {[25, 50, 75, 100].map((milestone) => {
                ...
                const isCurrent =
                  milestone === Math.floor(progress.percentage / 25) * 25;
                  ...
                  <View key={milestone} style={styles.milestoneItem}>
                    ...
                    <View style={styles.milestoneContent}>
                      <Text style={styles.milestoneLabel}>
                        {milestone}% - CHF {milestoneAmount.toLocaleString()}
                      </Text>
